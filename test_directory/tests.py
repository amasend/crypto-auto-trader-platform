...
<<<<<<< HEAD:test_directory/connection_tests.py
from downloader.current_data_provider.provider_manager import provide_current_data
=======
from downloader.current_data_provider.provider_manager import CurrentDataProvider
>>>>>>> dev:test_directory/tests.py
